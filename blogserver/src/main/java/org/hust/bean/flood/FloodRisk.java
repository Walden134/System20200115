...
//		}
        ...
        designFloods.put("d_7", getDesignFlood(baseFloodJson, bmaPJson, "5"));
        designFloods.put("d_15", getDesignFlood(baseFloodJson, bmaPJson, "6"));
        return designFloods;
    }

    public double[][] getDesignFlood(String baseFloodJson, String bmaPJson, String bmaQ) {
        ...
        try {
            ...
            c.eval("nu<-pa[4]");
            c.eval("location<-array(mu*(1-sigma/nu),dim=c(100,80))");
            c.eval("scale<-array((mu*sigma*nu),dim=c(100,80))");
            c.eval("qpiii<-qpearsonIII(0.998,shape=1/(nu*nu), location=mu*(1-sigma/nu), scale=(mu*sigma*nu))");
...
//		List<double[][]> Qing = floodHydrograph;
    ...
    public List<double[]> getRiskRes(List<double[]> typicalFloods, String baseFloodJson, List<double[]> ObjP,
        ...
        Map<String, double[][]> designFloods = getDesignFloods(baseFloodJson, bmaPJson);
