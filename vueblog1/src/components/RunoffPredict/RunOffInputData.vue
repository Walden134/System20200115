<template>
  <div style="width:100%">
    <el-form :inline="true" class="demo-form-inline" :label-position="labelPosition" size="small">
      ...
      <div class="input">
        <div>
          <label class="run_label" for="" style="width:80px">未来气温</label>
          <uploadExcel @func="getTemperature"> </uploadExcel>
        </div>
        <div>
          <label class="run_label" for="" style="width:80px">未来降水</label>
          <uploadExcel @func="getPrecipitation"> </uploadExcel>
        </div>
        <div>
          <label class="run_label" for="" style="width:80px">实测径流</label>
