    ...
    <el-form :inline="true"
      ...
      <el-form-item style="margin-top:10px;margin-bottom: 0px">
        <el-button type="primary"
                   @click.native.prevent="submitClick1">开始计算</el-button>
        <el-button type="warning"
                   @click.native.prevent="resetData1">重置</el-button>
      ...
      <div class="pattern">
        ...
        <el-form-item label="样本均值Ex"
          ...
          <el-input style=" width:100px"
                    v-model="exx"></el-input>
        </el-form-item>
        <el-form-item label="变差系数Cv"
                      style="margin-bottom: 1px; ">
          <el-input style=" width:100px"
                    v-model="cvv"></el-input>
        </el-form-item>
        <el-form-item label="偏态系数Cs"
                      style="margin-bottom: 1px; ">
          <el-input style=" width:100px"
                    v-model="css"></el-input>
        </el-form-item>
      </div>
      <el-form-item style="margin-top: 10px;margin-bottom: 0px">
        <el-button type="primary"
                   @click.native.prevent="submitClick2">开始计算</el-button>
        <el-button type="warning"
                   @click.native.prevent="resetData2">重置</el-button>
