  ...
  <div style="width:100%">
    ...
    <el-form :inline="true"
      ...
      <div class="input">
        ...
        <label class="gen_label"
               for="">实测洪水&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
        <uploadExcel style="margin-top: 10px;"
                     @func="getMesureData"> </uploadExcel>
        <el-form-item label="历史调查期年数"
                      style="margin-bottom: 1px; ">
          <el-input style=" width:110px"
                    v-model="params.n"></el-input>
        </el-form-item>
        <el-form-item label="特大洪水项数"
                      style="margin-bottom: 1px; ">
          <el-input style=" width:110px"
                    v-model="params.a"></el-input>
        </el-form-item>
        <el-form-item label="实测系列的年数"
                      style="margin-bottom: 1px; ">
          <el-input style=" width:110px"
                    v-model="params.l"></el-input>
        </el-form-item>
      </div>
      <el-form-item style="margin-top: 10px;margin-bottom: 0px">
        <el-button type="warning"
                   @click.native.prevent="expFrequencyClick">经验频率计算</el-button>
      </el-form-item>
      ...
      <div class="params">
        <el-form-item label="样本均值Ex"
                      style="margin-bottom: 1px; ">
          <el-input style=" width:110px"
                    v-model="params.ex"></el-input>
        </el-form-item>
        <el-form-item label="变差系数Cv"
                      style="margin-bottom: 1px; ">
          <el-input style=" width:110px"
                    v-model="params.cv"></el-input>
        </el-form-item>
        <el-form-item label="偏态系数Cs"
                      style="margin-bottom: 1px; ">
          <el-input style=" width:110px"
                    v-model="params.cs"></el-input>
        </el-form-item>
      ...
      <el-form-item style="margin-top: 10px;margin-bottom: 0px">
        <el-button type="warning"
                   @click.native.prevent="paramEstClick">参数估计</el-button>
        <el-button type="primary"
                   @click.native.prevent="drawLineClick">绘制曲线</el-button>
      </el-form-item>
